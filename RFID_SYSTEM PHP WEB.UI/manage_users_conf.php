                ...
                if (!empty($Uname) && !empty($Number) && !empty($Email)) {
                    ...
                    if (!mysqli_stmt_prepare($result, $sql)) {
                        ...
                        if (!$row = mysqli_fetch_assoc($resultl)) {
                            ...
                            echo "Seri numarası zaten mevcut";
                            exit();
                        }
                    }
                }
    ...
    if (!mysqli_stmt_prepare($result, $sql)) {
      ...
      exit();
        ...
        if ($row = mysqli_fetch_assoc($resultl)) {
            ...
            if ($row['add_card'] == 0) {
                echo "Öncelikle personeli ekleyin";
                exit();
            }
            else{
                if (empty($Uname) && empty($Number) && empty($Email)) {
            ...
            echo "Güncellenecek seçili personel yok lütfen personel seçiniz";
            exit();
        }
    }
}
...
if (isset($_POST['delete'])) {
    ...
    if (empty($user_id)) {
        echo "Kaldırılacak seçili kullanıcı mevcut değil";
        exit();
    } else {
